...
public class Expression {
    ...
    public Expression addHint() {
        ...
        Fraction op1H = new Fraction(this.op1.getNumerator(), comDenom);
        Fraction op2H = new Fraction(this.op2.getNumerator(), comDenom);
    ...
    public Expression subHint() {
        ...
        Fraction op1H = new Fraction(this.op1.getNumerator(), comDenom);
        Fraction op2H = new Fraction(this.op2.getNumerator(), comDenom);
        Expression subH = new Expression(op1H, op2H, this.op);
        
        return new Expression(subH.op1, subH.op2, this.op);
    }
